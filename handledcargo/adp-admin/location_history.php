                ...
                <table class="table table-stripped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>  
                            <center>  
                                <a href='includes/contactDetails.php?del=<?php echo $rows['id']; ?>' type='button' class='btn btn-danger' style='margin-right: 5px;'><i class='fas fa-trash-alt'></i> Delete Consignment</a>
                               <a id="" href='update_client.php?id=<?php echo $rows['id'] ?>' target='_self' type='button' class='btn btn-info' style='margin-right: 5px'><i class='fas fa-pen'></i> Update Location</a>
                               <a id="" href='update_client.php?id=<?php echo $rows['id'] ?>' target='_self' type='button' class='btn btn-info' style='margin-right: 5px'><i class='fas fa-pen'></i>View Location History</a>
                            </center>
                            </td>   
                        </tr>
                  <?php
