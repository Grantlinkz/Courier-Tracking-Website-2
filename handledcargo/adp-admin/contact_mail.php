...
<html>
    <head>
        ...
        <title>Contact Mail | Best Delivery Logistics </title>
         ...
         <div class="container-fluid">
                <a href="" class="btn btn-primary">
                    <i class="fas fa-plus-circle"></i>
                     STATS: <?php $sql="select * from quote ";
                ...
                <table class="table table-stripped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>  
                            <center>  
                                <a href='includes/contactDetails2.php?delContact=<?php echo $rows['id']; ?>' type='button' class='btn btn-danger' style='margin-right: 5px;'><i class='fas fa-trash-alt'></i></a>
